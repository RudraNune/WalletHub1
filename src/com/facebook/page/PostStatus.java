...
public class PostStatus {
	...
	public PostStatus() {
		try {
			...
			FileInputStream ip = new FileInputStream(
					System.getProperty("user.dir") + "\\src\\com\\facebook\\properties" + "\\config.properties");
			prop.load(ip);
	...
	public void initialization() {
		...
		if (browserName.equals("chrome")) {
			...
			System.setProperty("webdriver.ie.driver",
					System.getProperty("user.dir") + "\\src\\com\\facebook\\resources\\IEDriverServer.exe");
	...
	public static void main(String[] args) throws InterruptedException {
		...
		ac.moveToElement(txtelement).doubleClick().sendKeys("Hello World").build().perform();
